...
import 'package:galsphone/views/phone_search_view.dart';
...
class _LoginPageState extends State<LoginPage> {
    ...
    SharedPref().getLoginStatus().then((status) {
      if (status) {
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => PhoneSearch()));
      }
    });
  }
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 16),
            _passwordSection(password_controller, 'Password'),
            SizedBox(height: 24),
            _buttonSubmit(),
          ],
        ),
  ...
  Widget _passwordSection(dynamic text_controller, String label) {
    return TextFormField(
      controller: text_controller,
      obscureText: true,
      decoration: InputDecoration(
